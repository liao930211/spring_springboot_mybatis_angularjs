...
Source Database       : lh_01

Target Server Type    : MYSQL
Target Server Version : 50528
File Encoding         : 65001

Date: 2016-05-30 00:04:05
*/
...
CREATE TABLE `sys_user` (
  ...
  `USER_NAME` varchar(200) DEFAULT NULL COMMENT '用户名字',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '2', '你好');
INSERT INTO `sys_user` VALUES ('2', '3', '4');
